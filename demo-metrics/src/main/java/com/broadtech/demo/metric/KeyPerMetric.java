...
public class KeyPerMetric {
    ...
    public KeyPerMetric(MetricRegistry metricRegistry) {
        ...
        metricRegistry.register(MetricRegistry.name("Metrics.KeyPerMetric", "freeMemory"), getFreeMemory());
        metricRegistry.register(MetricRegistry.name("Metrics.KeyPerMetric", "usableMemory"), getUsableMemory());
