...
public class MetricsServlet extends HttpServlet {
    ...
    private transient MetricProduct metricProduct;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        this.metricProduct = new MetricProduct(registry, module);
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (OutputStream output = resp.getOutputStream()) {
            ...
            if (jsonpParamName != null && req.getParameter(jsonpParamName) != null) {
                metricProduct.output(output, prettyPrint, req.getParameter(jsonpParamName));
            } else {
                metricProduct.output(output, prettyPrint);
            }
        }
    }
