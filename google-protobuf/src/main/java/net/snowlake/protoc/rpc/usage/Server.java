...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        // 回调  
        final RpcCallback<ProtoService.Msg> clientResponseCallback = new RpcCallback<ProtoService.Msg>() {
            @Override
        ...
        RpcConnectionEventListener listener = new RpcConnectionEventListener() {
            ...
            public void connectionReestablished(RpcClientChannel clientChannel) {
                ...
                clientChannel.setOobMessageCallback(ProtoService.Msg.getDefaultInstance(), clientResponseCallback);
            }
        ...
        while (true) {
            ...
            for (RpcClientChannel client : clients) {
                //创建消息  
                ProtoService.Msg msg = ProtoService.Msg.newBuilder().setContent("Server " + serverFactory.getServerInfo() + " OK@" + System.currentTimeMillis()).build();
