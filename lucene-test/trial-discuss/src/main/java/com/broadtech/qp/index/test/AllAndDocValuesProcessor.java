 ...
 */
public class AllAndDocValuesProcessor extends BaseIndexProcessor {
    public AllAndDocValuesProcessor(RuntimeStatus status, CtlConfig ctl) {
        super(status, ctl);
    }

    @Override
    protected String getBaseIndexPath() {
        return DataQueue.BASE_PATH + "/docValuesType";
    }
