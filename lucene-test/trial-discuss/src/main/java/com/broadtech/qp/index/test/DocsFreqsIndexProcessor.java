 ...
 */
public class DocsFreqsIndexProcessor extends BaseIndexProcessor {
    public DocsFreqsIndexProcessor(RuntimeStatus status, CtlConfig ctl) {
        super(status, ctl);
    }

    @Override
    protected String getBaseIndexPath() {
        return DataQueue.BASE_PATH + "/docsAndFreqs";
    }
