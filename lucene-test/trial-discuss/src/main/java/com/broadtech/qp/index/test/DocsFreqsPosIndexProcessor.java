 ...
 */
public class DocsFreqsPosIndexProcessor extends BaseIndexProcessor {
    public DocsFreqsPosIndexProcessor(RuntimeStatus status, CtlConfig ctl) {
        super(status, ctl);
    }

    @Override
    protected String getBaseIndexPath() {
        return DataQueue.BASE_PATH + "/docsAndFreqAndPos";
    }
