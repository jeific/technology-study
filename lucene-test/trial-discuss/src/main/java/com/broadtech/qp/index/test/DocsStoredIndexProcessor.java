 ...
 */
public class DocsStoredIndexProcessor extends BaseIndexProcessor {
    public DocsStoredIndexProcessor(RuntimeStatus status, CtlConfig ctl) {
        super(status, ctl);
    }

    @Override
    protected String getBaseIndexPath() {
        return DataQueue.BASE_PATH + "/docsAndStored";
    }
