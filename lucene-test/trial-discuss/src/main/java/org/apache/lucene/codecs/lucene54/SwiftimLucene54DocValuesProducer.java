 ...
 */
final class SwiftimLucene54DocValuesProducer extends DocValuesProducer implements Closeable {
    ...
    SwiftimLucene54DocValuesProducer(SwiftimLucene54DocValuesProducer original) throws IOException {
     ...
     */
    SwiftimLucene54DocValuesProducer(SegmentReadState state, String dataCodec, String dataExtension, String metaCodec, String metaExtension) throws IOException {
    ...
    public synchronized DocValuesProducer getMergeInstance() throws IOException {
        return new SwiftimLucene54DocValuesProducer(this);
    }
