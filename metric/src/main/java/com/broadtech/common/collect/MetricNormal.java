...
public class MetricNormal {
    ...
    public MetricNormal(MetricRegistry useMetricRegistry, MetricsModule module) {
    ...
    public void output(OutputStream out, boolean pretty, String function) throws IOException {
